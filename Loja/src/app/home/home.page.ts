...
export class HomePage {
  ...
  /*
  Vamos receber os produtos cadastrados no forma de json da 
    ...
    */
    ngOnInit(){
      ...
      Os comandos:
        ...
        construtor da classe. Construtor é reponsável por iniciar
        ...
        this.url.
        O comando subscribe(Observable) é reponsável por recepcionar
