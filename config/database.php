...
E uma variável para a conexao com o banco que será usada em outros 
...
class Database{
    ...
    public function getConnection(){
        try{
            $conexao =  new PDO("mysql:host=mysql22.redehost.com.br;
            port=3306;dbname=apidb","alunos","Alunos#api1");
